...
class NEWHead(AnchorFreeHead):
    ...
    def init_weights(self):
        super(NEWHead, self).init_weights()
    ...
    def deform_sampling(self, feat, offset):
        b, c, h, w = feat.shape  #torch.Size([4,4,76,128])
    ...
    def forward_single(self, x, scale_refine, scale, stride):
        b, c, h, w = x.shape  #torch.Size([256, 7, 7])  #torch.Size([4,256,76,128])
        ...
        if self.with_reg_refine:
            ...
            bbox_pred = bbox_pred_refine * bbox_pred.detach()
